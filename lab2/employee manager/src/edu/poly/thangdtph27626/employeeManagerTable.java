   ...
   private void dataStaff(){
    ...
    private void initTable(){
       DefaultTableModel model = new DefaultTableModel();
        ...
        for(Staff staff : list){
            model.addRow(new String[]{staff.getId(),staff.getFullName(),staff.getCountry(),staff.getGender(),staff.getStatus()});
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(employeeManagerTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new employeeManagerTable().setVisible(true);
            }
        });
    }
