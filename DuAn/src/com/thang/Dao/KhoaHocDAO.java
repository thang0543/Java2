...
import com.thang.model.KhoaHoc;
...
public class KhoaHocDAO {
    ...
    public void insert(KhoaHoc model) {
        String sql ="insert into KhoaHoc(MaCD, HocPhi, ThoiLuong, NgayKG, ghiChú, MaNV) values(?,?,?,?,?,?)";
    ...
    public void update(KhoaHoc model) {
        String sql =
        "UPDATE KhoaHoc SET MaCD=?, HocPhi=?, ThoiLuong=?, NgayKG=?, ghiChú=?, MaNV=? WHERE MaKH like  ?";
    ...
    private KhoaHoc readFromResultSet(ResultSet rs) throws SQLException {
        ...
        model.setGhiChu(rs.getString("ghiChú"));
